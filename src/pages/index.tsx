...
const Home: React.FC<HomeProps> = ({ numFound }) => {
  ...
  return (
    <>
      <Head>
        <title>
          {`peviitor | Motor de căutare ${numFoundText} locuri de muncă`}
        </title>
        <meta
          name="description"
          content={`peviitor.ro - Motor de căutare  ${numFoundText} locuri de muncă disponibile`}
        />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
      </Head>
      <main className="landing-page flex flex-col justify-between items-center py-5 min-h-[100vh]">
